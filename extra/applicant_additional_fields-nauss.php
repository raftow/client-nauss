...
$additional_fields = [
    ...
    'attribute_9' => array('type' => 'TEXT','css' => 'width_pct_25', 'size' => 64, 'step' => 2, 'fgroup' => 'rayat', 'field_code' => 'rayat_dismissed_semester', 'optional' => false, 
                'title_ar' => 'الفصل التدريبي لاجراء الفصل من التدريب', 'title_en' => 'Training class to conduct a class from training', 'help' => ''),

    'attribute_10' => array('type'=> 'YN',  'css' => 'width_pct_50', 'size' => 64, 'step' => 8, 'fgroup' => 'disability', 'field_code' => 'social_security_beneficiary_child', 'optional' => FALSE, 
                'title_ar' => 'من ابناء مستفيدي الضمان الاجتماعي', 'title_en' => 'Child of a Social Security beneficiary', 'help' => '' ),

    'attribute_11' => array('type' => 'YN', 'css' => 'width_pct_25', 'size' => 64, 'step' => 2, 'fgroup' => 'rayat', 'field_code' => 'uoh_enroll_ind', 'optional' => false, 
                'title_ar' => 'المتقدم مقيد في جامعة حائل', 'title_en' => 'Continuing in Hail University', 'help' => ''),
    
    'attribute_12' => array('type' => 'YN', 'css' => 'width_pct_25', 'size' => 64, 'step' => 2, 'fgroup' => 'rayat', 'field_code' => 'rayat_EN_graduated_ind', 'optional' => false, 
                'title_ar' => 'خريج برنامج الإنجليزية المكثف', 'title_en' => 'raduate of the Intensive English Program', 'help' => ''),
    'attribute_13' => array('type' => 'YN', 'css' => 'width_pct_25', 'size' => 64, 'step' => 2, 'fgroup' => 'rayat', 'field_code' => 'rayat_DP_graduated_ind', 'optional' => false, 
                'title_ar' => 'خريج دبلوم المعاهد الصناعية الثانوية', 'title_en' => 'Diploma graduate of secondary industrial institutes', 'help' => ''),
    'attribute_14' => array('type' => 'YN', 'css' => 'width_pct_25', 'size' => 64, 'step' => 2, 'fgroup' => 'rayat', 'field_code' => 'rayat_UG_graduated_ind', 'optional' => false, 
                'title_ar' => 'خريج دبلوم بكالوريوس الكلية التقنية', 'title_en' => 'Graduate of Bachelor s Degree in Technical College', 'help' => ''),
    'attribute_15' => array('type' => 'YN', 'css' => 'width_pct_25', 'size' => 64, 'step' => 2, 'fgroup' => 'rayat', 'field_code' => 'rayat_PR_graduated_ind', 'optional' => false, 
                'title_ar' => 'خريج برامج المعاهد الصناعية', 'title_en' => 'Graduate of industrial institute programs', 'help' => ''),
    'attribute_16' => array('type' => 'YN', 'css' => 'width_pct_25', 'size' => 64, 'step' => 2, 'fgroup' => 'rayat', 'field_code' => 'rayat_AS_graduated_ind', 'optional' => false, 
                'title_ar' => 'خريج دبلوم الكلية التقنية', 'title_en' => 'Graduate of technical college diploma', 'help' => ''),
    'attribute_17' => array('type' => 'GDAT', 'css' => 'width_pct_25', 'size' => 64, 'step' => 2, 'fgroup' => 'rayat', 'field_code' => 'rayat_activity_date', 'optional' => false, 
                'title_ar' => 'تاريخ الحركة في رايات', 'title_en' => 'Activity date', 'help' => ''),
    ...
    'attribute_29' => array('type' => 'INT', 'css' => 'width_pct_25', 'size' => 24, 'step' => 2, 'fgroup' => 'qiyas', 'field_code' => 'qiyas_achievement_th', 'optional' => false, 
                'title_ar' => 'درجةاختبار التحصيل الدراسي-التخصصات النظرية', 'title_en' => 'Academic achievement test score - theoretical', 'help' => ''),
    'attribute_30' => array('type' => 'GDAT', 'css' => 'width_pct_25', 'size' => 24, 'step' => 2, 'fgroup' => 'qiyas', 'field_code' => 'qiyas_achievement_th_date', 'optional' => false, 
                'title_ar' => 'تاريخ اختبار التحصيلي-التخصصات النظرية', 'title_en' => 'History of the achievement test - theoretical', 'help' => ''),
    'attribute_31' => array('type' => 'INT', 'css' => 'width_pct_25', 'size' => 24, 'step' => 2, 'fgroup' => 'qiyas', 'field_code' => 'qiyas_aptitude_sc', 'optional' => false, 
                'title_ar' => 'درجة اختبار القدرات العامة-التخصصات العلمية', 'title_en' => 'General aptitude test score - scientific', 'help' => ''),
    'attribute_32' => array('type' => 'GDAT', 'css' => 'width_pct_25', 'size' => 24, 'step' => 2, 'fgroup' => 'qiyas', 'field_code' => 'qiyas_aptitude_sc_date', 'optional' => false, 
                'title_ar' => 'تاريخ اختبار القدرات العامة-التخصصات العلمية', 'title_en' => 'Date of the general aptitude test - scientific', 'help' => ''),
    'attribute_33' => array('type' => 'INT', 'css' => 'width_pct_25', 'size' => 24, 'step' => 2, 'fgroup' => 'qiyas', 'field_code' => 'qiyas_aptitude_th', 'optional' => false, 
                'title_ar' => 'درجة اختبار القدرات العامة-التخصصات النظرية', 'title_en' => 'General aptitude test score - theoretical', 'help' => ''),
    'attribute_34' => array('type' => 'GDAT', 'css' => 'width_pct_25', 'size' => 24, 'step' => 2, 'fgroup' => 'qiyas', 'field_code' => 'qiyas_aptitude_th_date', 'optional' => false, 
                'title_ar' => 'تاريخ اختبار القدرات العامة-التخصصات النظرية', 'title_en' => 'Date of general aptitude testing - theoretical', 'help' => ''),
    'attribute_35' => array('type' => 'INT', 'css' => 'width_pct_25', 'size' => 24, 'step' => 2, 'fgroup' => 'qiyas', 'field_code' => 'qiyas_achievement_sc', 'optional' => false, 
                'title_ar' => 'درجةاختبار التحصيل الدراسي-التخصصات العلمية', 'title_en' => 'Academic achievement test score - scientific', 'help' => ''),
    'attribute_36' => array('type' => 'GDAT', 'css' => 'width_pct_25', 'size' => 24, 'step' => 2, 'fgroup' => 'qiyas', 'field_code' => 'qiyas_achievement_sc_date', 'optional' => false, 
                'title_ar' => 'تاريخ اختبار التحصيلي-التخصصات العلمية', 'title_en' => 'Date of the achievement test - scientific', 'help' => ''),    
    'attribute_37' => array('type' => 'GDAT', 'css' => 'width_pct_25', 'size' => 24, 'step' => 2, 'fgroup' => 'qiyas', 'field_code' => 'qiyas_activity_date', 'optional' => false, 
